...
$keyword = $_GET["keyword"]; // mengambil keyword
   ...
   $x++;
    if ($x==1){
     ...
     {
	 $construct .= " OR kata LIKE '%$search_each%'"; // query jika kata lebih dari satu
	 }
...
// select distinct untuk mengambil berita agar tidak terjadi duplikasi
?>
